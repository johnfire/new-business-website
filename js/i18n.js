...
const TRANSLATIONS = {
  de: {
    ...
    about_bio2:         'Als Design-Ingenieur bei Intel entwickelte ich Netzwerkprozessoren in VHDL. Seit über 6 Jahren baue ich Web-Applikationen mit React, Node.js, TypeScript und MongoDB. Ich bin auch Krebsüberlebender — sechs Jahre widmete ich mich dem Holzschnittdruck während meiner Genesung.',
  ...
  en: {
    ...
    about_bio2:         'As a design engineer at Intel I built network processors in VHDL. For 6+ years I\'ve been building web applications in React, Node.js, TypeScript, and MongoDB. I\'m also a cancer survivor — I spent six years doing woodblock printing during my recovery.',
